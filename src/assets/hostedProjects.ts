...
export const hostedProjects: HostedProject[] = [
  {
    ...
    name: "Pluginator",
    description:
      "Web app for managing Minecraft server plugins — multi-source update checking and downloading.",
    status: "live",
    url: "https://pluginator.nindroidsystems.com",
    repoUrl: "https://github.com/NindroidA/pluginator",
    icon: "blocks",
    stack: ["TypeScript", "Bun", "Web"],
  },
  {
    id: "cogworks-bot",
    name: "Cogworks Bot",
    description:
      "Modular Discord server management bot — tickets, applications, reaction roles, announcements, and more.",
    status: "live",
  ...
  {
    id: "cogworks-dashboard",
    name: "Cogworks Dashboard",
    description: "The web dashboard for configuring and managing the Cogworks bot.",
    status: "live",
    url: "https://cogworks.nindroidsystems.com",
    icon: "dashboard",
    stack: ["React", "TypeScript", "Web"],
  },
  {
    id: "respool",
    name: "Respool",
